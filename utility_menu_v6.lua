...
local function createmenu()
	...
	createmessage("This Lua script was made for me and a friend, but mainly for me. It adds a lot of fun and useful features, like a mini-map, Freecam, and ESP for NPCs, props, and players.", scrollinfo)
